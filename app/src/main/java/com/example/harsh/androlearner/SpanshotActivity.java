...
import com.example.harsh.androlearner.adapter.FilterAdapter;
...
/**
 * Created by harsh on 09/10/16.
 */

public class SpanshotActivity extends Activity {
    ...
    public CameraEngine camera_engine;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("AmazeLogs", "OnCreateSpanshotActivity");
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.btn_camera_shutter:
                    if (PermissionChecker.checkSelfPermission(SpanshotActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)
                            == PackageManager.PERMISSION_DENIED) {
                        ActivityCompat.requestPermissions(SpanshotActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},
                                v.getId());
                    } else {
                        takeVideo();
                    }
                ...
                case R.id.btn_camera_beauty:
                    new AlertDialog.Builder(SpanshotActivity.this)
                            .setSingleChoiceItems(new String[]{"None", "1", "2", "3", "4", "5"}, MagicParams.beautyLevel,
    ...
    public void onResume() {
        super.onResume();
        magicEngine = builder.build((MagicCameraView) findViewById(R.id.glsurfaceview_camera));
        initView();// Always call the superclass method first
    }
    @Override
    public void onBackPressed() {
        Intent setIntent = new Intent(SpanshotActivity.this, MainActivity.class);
